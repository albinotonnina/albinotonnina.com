...
},{"./Site":1,"./utilities":4,"throttle-debounce":15}],3:[function(require,module,exports){
"use strict";
...
var get = exports.get = function get(url, onSuccess, onFailure) {
    ...
    fetch(baseUrl + url).then(function (res) {
        return res.text();
    }).then(function (body) {
...
},{"webfontloader":17,"whatwg-fetch":18}],5:[function(require,module,exports){
'use strict';
...
},{"./throttle":16}],15:[function(require,module,exports){
var throttle = require('./throttle');
...
},{"./debounce":14,"./throttle":16}],16:[function(require,module,exports){
